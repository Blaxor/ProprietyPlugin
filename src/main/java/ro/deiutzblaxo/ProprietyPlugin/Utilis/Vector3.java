...
public class Vector3 implements Comparable<Vector3> {
	...
	public Vector3(Vector2 vector, float z) {
		this(vector.getX(), z, vector.getY());
	}
	...
	/**
	 * Returns a Vector2 object using the X and Z values of this Vector3. The x of
	 * this Vector3 becomes the x of the Vector2, and the z of this Vector3 becomes
	 * the y of the Vector2.
	 * 
	 * @return
	 */
	...
	/**
	 * Returns a Vector2m object using the X and Z values of this Vector3. The x of
	 * this Vector3 becomes the x of the Vector2, and the z of this Vector3 becomes
	 * the y of the Vector2m.
	 * 
	 * @return
	 */
	...
	/**
	 * returns the length of this vector. Note: makes use of Math.sqrt and is not
	 * cached.
	 *
	 * @return
	 */
	...
	public boolean equals(Object o) {
		if (o instanceof Vector3) {
			...
			if (Math.round(vec.x) == Math.round(x) && Math.round(vec.y) == Math.round(y)
					&& Math.round(vec.z) == Math.round(z)) {
				return true;
			}
	...
	public static Vector3 cross(Vector3 a, Vector3 b) {
		return new Vector3(a.getY() * b.getZ() - a.getZ() * b.getY(), a.getZ() * b.getX() - a.getX() * b.getZ(),
				a.getX() * b.getY() - a.getY() * b.getX());
	}

	/**
	 * Rounds the X, Y, and Z values of the given Vector3 up to the nearest integer
	 * value.
	 * 
	...
	/**
	 * Returns a Vector2 object using the X and Z values of the given Vector3. The x
	 * of the Vector3 becomes the x of the Vector2, and the z of this Vector3
	...
	/**
	 * Returns a Vector2m object using the X and Z values of the given Vector3. The
	 * x of the Vector3 becomes the x of the Vector2m, and the z of this Vector3
	 * becomes the y of the Vector2m.
	 * 
	 * @param o Vector3 object to use
	 * @return
